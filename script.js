...
(function (UserStatus) {
    ...
    UserStatus["VerifyingLogIn"] = "Verifying Log In";f
...
const WeatherSnap = () => {
    ...
    return (React.createElement("span", { className: "weather" },
        ...
        React.createElement("span", { className: "weather-temperature-value" }, "lol"),
...
const Reminder = () => {
    return (React.createElement("div", { className: "reminder" },
        ...
        React.createElement("span", { className: "reminder-text" },
            "Gank Miracle, IUE(Ignition Union Empire) & Fruity Ninjas guilds'. ",
            React.createElement("span", { className: "reminder-time" }, "6PM"))));
};
const Time = () => {
...
const Pin = () => {
    ...
    return (React.createElement("div", { id: "app-pin-wrapper" },
        ...
        React.createElement("h3", { id: "app-pin-label" },
            "https://pastebin.com/raw/iYdfm0fb",
            getErrorText(),
            " ",
            getCancelText())));
};
...
const Movies = () => {
    const getMovies = () => {
        return [{
                desc: "A space-based, persistent world massively multiplayer online role-playing game developed and published by CCP Games.",
                id: 1,
                icon: "fa-solid fa-galaxy",
                image: "https://i.imgur.com/hU10u18.png",
                title: "EVE Online"
            }, {
                desc: "A multiplayer action-spellcasting game where you unleash your inner battlemage.",
                id: 2,
                icon: "fa-solid fa-hat-wizard",
                image: "https://i.imgur.com/8wusTIw.jpg",
                title: "Spellbreak"
            }, {
    ...
    return (React.createElement("div", { id: "app-menu" },
        React.createElement("div", { id: "app-menu-content-wrapper" },
            React.createElement("div", { id: "app-menu-content" },
                ...
                React.createElement("a", { id: "contactOutlook", className: "clear-button", href: "https://outlook.office.com/", target: "_blank" },
                    React.createElement("i", { className: "fa-sharp fa-solid fa-mug-hot" }),
                    React.createElement("span", null, "impvster")),
